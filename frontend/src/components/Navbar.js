...
function Navbar() {
    ...
    return (
        <>
                ...
                <div className="px-3 py-2 bg-dark text-white">
                    <div className="container">
                        <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                            ...
                            <button
                                type="button"
                                className="btn btn-warning col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0"
                            ...
                            <form className="col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3">
                                <input type="search" className="form-control form-control-dark" placeholder="Search work orders by ID..." aria-label="Search"/>
                            </form>
            ...
            {newOrder && <NewWorkOrder onClose={() => setNewOrder(false)} />}
        </>        
    );    
